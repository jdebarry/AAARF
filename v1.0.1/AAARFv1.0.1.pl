...
#--------------------------------------+
my $maxBlastHits=100;       # maximum number of hits used to construct coverage matrix, default 100
my $minBlastMatch=150;      # minimum length for a BLAST hit, default 150
...
#-----------------------+
#GETOPT::LONG PARAMETERS|
#-----------------------+
GetOptions(
	"maxBlastHits=i"		=> \$maxBlastHits,
	"minBlastMatch=i"		=> \$minBlastMatch,
	"minBlastIdentity=s"	=> \$minBlastIdentity,
	"minBlastCoverDepth=i"	=> \$minBlastCoverDepth,
	"minBlastConsenLen=i"	=> \$minBlastConsenLen,
	"BLAST_e=s"				=> \$BLAST_e,
	"BL2SEQ_e=s"			=> \$BL2SEQ_e,
	"maxExtendHits=i"		=> \$maxExtendHits,
	"minExtendHits=i"		=> \$minExtendHits,
	"maxExtendLen=i"		=> \$maxExtendLen,
	"minExtendLen=i"		=> \$minExtendLen,
	"minCoverLen=i"			=> \$minCoverLen,
	"minOverlapLen=i"		=> \$minOverlapLen,
...
my $blastOut = getBlastOutput($qSeq, $inputFile);
...
my $blastOuttest = getBlastOutput($qSeq, $inputFile);
